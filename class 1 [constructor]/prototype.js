...
const rakeshAccount = new BankAccount({ customerName: "Rakesh K" });
const johnDoe = new BankAccount({ customerName: "John Doe" });
console.log(rakeshAccount, johnDoe);
...
console.log('after deposited---',rakeshAccount)

johnDoe.deposit(3500)
console.log('after deposited john ',johnDoe)